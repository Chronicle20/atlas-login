...
func SeedCharacter(l logrus.FieldLogger, ctx context.Context, tenant tenant.Model) func(accountId uint32, worldId byte, name string, jobIndex uint32, subJobIndex uint16,
	...
	return func(accountId uint32, worldId byte, name string, jobIndex uint32, subJobIndex uint16,
		...
		c, err := requestCreate(ctx, tenant)(accountId, worldId, name, jobIndex, subJobIndex, face, hair, color, skinColor, gender, top, bottom, shoes, weapon, strength, dexterity, intelligence, luck)(l)
		if err != nil {
